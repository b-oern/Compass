...
import net.bsnx.apps.compass.model.AppError
import net.bsnx.apps.compass.model.Azimuth
import net.bsnx.apps.compass.model.DisplayRotation
import net.bsnx.apps.compass.model.LocationStatus
import net.bsnx.apps.compass.model.RotationVector
import net.bsnx.apps.compass.model.SensorAccuracy
import net.bsnx.apps.compass.preference.PreferenceStore
import net.bsnx.apps.compass.util.MathUtils
import net.bsnx.apps.compass.view.CompassViewModel
import com.google.android.material.color.MaterialColors
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import net.bsnx.apps.compass.databinding.FragmentCompassBinding
import net.bsnx.apps.compass.databinding.SensorAlertDialogViewBinding
